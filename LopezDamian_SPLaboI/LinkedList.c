...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    {
        auxReturn = this->pFirstNode;
        while(nodeIndex>0)
        {
            auxReturn = auxReturn->pNextNode;
            nodeIndex--;
        }
...
int ll_add(LinkedList* this, void* pElement)
{
    ...
    return returnAux;
    /**
    return add_node(this,ll_len(this),pElement);
    */
}
...
void* ll_pop(LinkedList* this,int index)
{
    ...
    if(this!=NULL && size>0 && index>=0 && index<size)
    {
 ...
 * \return LinkedList* una lista con los elementos que pasaron la prueba de la funcion pFunc
 *
 */
...
void* asignarValores(void* element)
{
    int sinVacuna;
    int unaDosis=dam_randomNumber(1,60);
    int dosDosis=dam_randomNumber(1,40);
    pais_setVac1dosis(element, unaDosis);
    pais_setVac2dosis(element, dosDosis);
    sinVacuna = 100-(unaDosis + dosDosis);
    pais_setSinVacunar(element, sinVacuna);
